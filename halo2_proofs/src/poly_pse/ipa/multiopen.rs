...
use super::*;
use crate::{arithmetic_pse::CurveAffine, poly_pse::query::Query, transcript::ChallengeScalar};
...
fn construct_intermediate_sets<F: Field, I, Q: Query<F>>(queries: I) -> IntermediateSets<F, Q>
where
