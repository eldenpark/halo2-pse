...
use super::ParamsIPA;
use crate::poly_pse::ipa::commitment::{IPACommitmentScheme, ParamsVerifierIPA};
use crate::{
    arithmetic::{best_multiexp, CurveAffine},
    poly_pse::ipa::strategy::GuardIPA,
};
use crate::{
    poly_pse::{commitment::MSM, ipa::msm::MSMIPA, strategy::Guard, Error},
