...
use crate::{
    arithmetic_pse::{eval_polynomial, lagrange_interpolate, CurveAffine},
    poly_pse::{query::Query, Coeff, Polynomial},
    transcript_pse::ChallengeScalar,
};
use rayon::prelude::*;
use std::{
...
fn construct_intermediate_sets<F: Field, I, Q: Query<F, Eval = F>>(
    queries: I,
